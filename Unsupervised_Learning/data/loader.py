...
class MushroomData(DataLoader):
    def __init__(self, path='data/agaricus-lepiota.data', verbose=False, seed=1):
        super().__init__(path, verbose, seed)
    ...
    def _preprocess_data(self):
        ...
        self._data.columns = list(range(len(self._data.columns)))

    def pre_training_adjustment(self, train_features, train_classes):
        return train_features, train_classes

class LetterRecognition(DataLoader):
    def __init__(self, path='data/letter-recognition.txt', verbose=False, seed=1):
        super().__init__(path, verbose, seed)
    ...
    def data_name(self):
        return 'Letter_Recognition_Data'
...
#    m_data = MushroomData()
#   m_data.load_and_process()
#   print(m_data._data)
#print(m_data._data[11])
