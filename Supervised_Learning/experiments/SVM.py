...
#                               'max_iter': 272, 'tol': 0.0200}
#        best_params_rbf = {'C': 1.501, 'class_weight': 'balanced', 'decision_function_shape': 'ovo',
#                            'gamma': 0.017544, 'max_iter': -1, 'tol': 0.02}
#        #Dataset 2:
#        best_params_linear = {'C': 2.0, 'class_weight': 'balanced', 'loss': 'squared_hinge', 'dual': False,
#                               'max_iter': 63, 'tol': 0.00000001}
#        best_params_rbf = {'C': 2.0, 'class_weight': 'balanced', 'decision_function_shape': 'ovo',
#                            'gamma': 0.0625, 'max_iter': -1, 'tol': 0.0001}
